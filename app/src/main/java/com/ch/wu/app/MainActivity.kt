...
import com.ch.wu.app.app.view.fragment.HomeFragment
import com.ch.wu.app.app.view.fragment.MessFragment
import com.ch.wu.app.app.view.fragment.MyFragment
import com.ch.wu.app.app.view.fragment.NearbyFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initView(){
        ...
        navigationBar.titleItems(tabText)
            ...
            .msgPointSize(15F)    //数字消息红色背景的大小
            .setMsgPointColor(Color.RED) //数字消息、红点背景颜色
            .setMsgPointMoreRadius(5) //消息99+角度半径
            .setMsgPointMoreWidth(25F)  //消息99+宽度
            .setMsgPointMoreHeight(15F)  //消息99+高度
            ...
            .setOnTabLoadListener {
                navigationBar.setMsgPointCount(2, 10)
            }
            .build()
    }
