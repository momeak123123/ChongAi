...
import com.ch.wu.app.bean.DataBean;
import com.ch.wu.app.holder.NetViewHolder;
import com.youth.banner.adapter.BannerAdapter;

import java.util.List;

class BannersAdapter extends BannerAdapter<DataBean, BannersAdapter.BannerViewHolder> {

    public BannersAdapter(List<DataBean> mDatas) {
